...
const partners = [
  { name: "OsDesign", logo: osdesignLogo, category: "Communication Partner" },
];
  ...
  <section id="partners" className="relative py-24 md:py-32">
    ...
    <div className="container mx-auto px-6 relative z-10">
      ...
      >
        ...
        <p className="text-xs font-bold text-primary uppercase tracking-widest mb-4">They trust us</p>
      </motion.div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-8">
          {partners.map((partner, i) => (
            <motion.div
              ...
              className="card-glass rounded-2xl px-10 py-8 flex flex-col items-center gap-4 cursor-default group"
            >
